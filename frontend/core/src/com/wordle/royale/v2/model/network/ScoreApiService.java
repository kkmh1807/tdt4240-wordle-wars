...
public class ScoreApiService {
    ...
    public void submitScore(String username, Integer score, final CallbackPostScore<HighScore> callback) {
    ...
    public void getHigscores(final CallbackPostScore<HighScore> callback) {
